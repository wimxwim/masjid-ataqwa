  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6">
      ...
      <div className="space-y-2 max-w-md">
        <h2 className="font-display font-bold text-2xl text-ink">Fitur Kajian & Silabus</h2>
        <p className="text-muted text-sm">
          Modul untuk merekam kurikulum dakwah, silabus kajian, dan streaming video sedang dalam tahap pengembangan (Fase 2).
        </p>
      </div>
      <div className="bg-surface border border-outline px-6 py-4 rounded-xl text-xs text-muted font-mono flex gap-3 items-center">
        ...
        Database Tabel (kajian_silabus) sudah tersambung
      </div>
    </div>
  );
}
