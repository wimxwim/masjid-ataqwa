...
import { Heart, Plus, CheckCircle2, Send } from "lucide-react";
      ...
      <form onSubmit={handleAddDonatur} className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <div className="flex items-end sm:col-span-3">
            <button type="submit"
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-amber-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2">
